...
pub async fn daily(repository: String, author: String) -> Result<CollectGitResult, String> {
    log::info!(
        "Starting Git record collection: repository={}, author={}",
        repository,
        author
    );
